  ...
  return (
    <div>
      ...
      >
            ...
            <div className="flex gap-1">
              {pokemonDetails.types.map((type) => (
                <div
                  ...
                  className={`${badgeTypeColors[type]} flex items-center gap-1 text-sm font-medium py-1 px-2 rounded-sm`}
                >
                  <PokemonTypeIcon
                    className="size-3.5 text-white dark:hover:text-bluewood-500 transition-colors duration-1000"
                    type={type}
                  />
        ...
        <div className="relative p-8 dark:bg-bluewood-900 border dark:border-bluewood-800 rounded-t-4xl space-y-10">
          <p className="dark:text-bluewood-400">{pokemonSpecie.description}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center">
                <span className="block font-medium w-[148px]">Height</span>
                <span className="block text-lg dark:text-bluewood-400">
                  {pokemonDetails.height}m
                </span>
              </div>
              <div className="flex items-center">
                <span className="block font-medium w-[148px]">Weight</span>
                <span className="block text-lg dark:text-bluewood-400">
                  {pokemonDetails.weight}kg
                </span>
              </div>
              <div className="flex">
                <span className="block w-[148px]">Abilities</span>
                <div className="space-y-2">
                  {pokemonDetails.abilities.map(({ name, isHidden }) => (
                    <span
                      key={name}
                      className={`block dark:text-bluewood-400 ${
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center">
                <span className="block font-medium w-[148px]">Catch Rate</span>
                <span className="block text-lg dark:text-bluewood-400">
                  {pokemonSpecie.captureRate}
                </span>
              </div>
              <div className="flex items-center">
                <span className="block font-medium w-[148px]">
                  Base Friendship
                </span>
                <span className="block text-lg dark:text-bluewood-400">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center">
                <span className="block font-medium w-[148px]">Egg Groups</span>
                <span className="block text-lg dark:text-bluewood-400">
